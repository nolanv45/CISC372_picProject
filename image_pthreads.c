...
// designed a struct to pass arguments to each thread
typedef struct {
    Image* srcImage;
    Image* destImage;
    Matrix* algorithm;
...
//            startRow: the starting row for this thread to process (added by me)
//            endRow: the ending row for this thread to process (added by me)
//Returns: Nothing
...
int main(int argc,char** argv){
    ...
    // end of my added code for threading
